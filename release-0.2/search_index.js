...
{
    "location": "man/dNdS.html#NaturalSelection.mkt",
    "page": "dNdS",
    "title": "NaturalSelection.mkt",
    "category": "Function",
    "text": "mkt(x, y, ref)\n\nCompute McDonald-Kreitman test statistics for two sets of codon sequences.\n\nThis function returns the values of Ps, Pn, Ds, Dn, α, and the neutrality index (NI).\n\n\n\n"
},

{
    "location": "man/dNdS.html#The-MacDonald-Kreitman-Test-1",
    "page": "dNdS",
    "title": "The MacDonald Kreitman Test",
    "category": "section",
    "text": "This test detects and measure the amount of adaptive evolution within a species by determining whether adaptive evolution has occurred, and the proportion of substitutions that resulted from positive selection.To do this, the McDonald–Kreitman test compares the amount of variation within a species (polymorphism) to the divergence between species (substitutions) at two types of sites, neutral and nonneutral.A substitution refers to a nucleotide that is fixed within one species, but a different nucleotide is fixed within a second species at the same base pair of homologous DNA sequences.The two types of sites can be either synonymous or nonsynonymous within a protein-coding region.The null hypothesis of the McDonald–Kreitman test is that the ratio of nonsynonymous to synonymous variation within a species is going to equal the ratio of nonsynonymous to synonymous variation between species (i.e. Dn/Ds = Pn/Ps).When positive or negative selection (natural selection) influences nonsynonymous variation, the ratios will no longer equal. The ratio of nonsynonymous to synonymous variation between species is going to be lower than the ratio of nonsynonymous to synonymous variation within species (i.e. Dn/Ds < Pn/Ps) when negative selection is at work, and deleterious mutations strongly affect polymorphism. The ratio of nonsynonymous to synonymous variation within species is lower than the ratio of nonsynonymous to synonymous variation between species (i.e. Dn/Ds > Pn/Ps) when we observe positive selection.Under neutrality the expectation is (Pn / Ps) == (Dn / Ds).The statistic α represents the proportion of substitutions driven by positive selection. α can be equal to any number between -Inf and 1. Negative values of alpha are produced by sampling error, assumption violations, or the segregation of slightly deleterious amino acid mutations. The null hypothesis here is that α = 0.The neutrality index (NI) quantifies the direction and degree of departure from neutrality (where Pn/Ps and Dn/Ds ratios equal). A neutrality index greater than 1 is indicative of negative selection, a neutrality index lower than 1 indicates positive selection is at work in the population.This test is provided by the function mkt.mkt"
},

{
    "location": "man/dNdS.html#References-1",
    "page": "dNdS",
    "title": "References",
    "category": "section",
    "text": "For more about the McDonald Kreitman Test, see the following references:https://en.wikipedia.org/wiki/McDonald%E2%80%93Kreitman_testMcDonald, J. H. Kreitman (1991)Charlesworth, J. Eyre-Walker (2008)Eyre-Walker, A (2006)Stoletzki, N. Eyre-Walker (2010)"
},
